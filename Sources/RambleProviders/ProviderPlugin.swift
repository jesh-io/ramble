...
public enum ProviderRegistry {
    ...
    public static func accountProviders(_ config: RambleConfig) -> [CleanupProvider] {
        config.accounts.filter(\.enabled).flatMap { account -> [CleanupProvider] in
            ...
            return models.map { model in
                ...
                return CleanupProvider(
                    ...
                    apiKey: account.apiKey ?? APIKeyStore.read("account/" + account.id),
    ...
    public static func allCleanupProviders(_ config: RambleConfig) -> [CleanupProvider] {
        config.cleanup.providers + accountProviders(config)
    }

    /// The provider the active id points at, searching both layers.
    public static func activeCleanupProvider(_ config: RambleConfig) -> CleanupProvider? {
    ...
    public static func sttProviders(_ config: RambleConfig) -> [STTProvider] {
    ...
    public static func activeSTTProvider(_ config: RambleConfig) -> STTProvider {
