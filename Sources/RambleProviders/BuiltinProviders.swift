...
enum BuiltinProviders {
    static let all: [ProviderPlugin] = [
        ...
        // MARK: Remote — speech-to-text (engines live in RambleTranscribeRemote)
        ProviderPlugin(
        ...
        ProviderPlugin(
            ...
            keyEnvSuggestion: "OPENAI_API_KEY",
            models: [
                ModelInfo("gpt-4o-transcribe", note: "batch", costPerMinute: 0.006),
                ModelInfo("gpt-4o-mini-transcribe", note: "batch", costPerMinute: 0.003),
        ...
        ProviderPlugin(
            ...
            keyEnvSuggestion: "MISTRAL_API_KEY",
            models: [
                ModelInfo("voxtral-mini-transcribe-2", note: "batch", costPerMinute: 0.003),
            ]),
        ProviderPlugin(
